...
const PropertySelective = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5041/api/Property/pageSelective?page=1&pageSize=2&propertyTypeId=${propertyType}&propertyStatusId=${propertyStatus}&currencyId=${currency}&lowerBoundMoney=${lowerPrice}&upperBoundMoney=${upperPrice}&startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}`)
            .then((response) => {
